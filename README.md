# A/B Testing & Product Analytics
    ...
    ## Project Overview
    Evaluate whether a new product feature improves user engagement and conversion.
    ...
    ## Business Questions
    - Did the new feature increase conversion rate?
- Was the result statistically significant?
- Which user segments responded best?
- Should the business launch the feature?

    ## Tools & Skills
    Python, Statistics, A/B Testing, Hypothesis Testing, Product Analytics

    ## Dataset
    The sample dataset is located in `/data/ab_test_data.csv`.
